...
def verify_task2():
    ...
    if os.path.isfile("task2_summary.json"):
...
def verify_task3():
    ...
    if os.path.isfile("task3_boxplot.png"):
...
def verify_task4():
    ...
    if os.path.isfile("task4_pie.png"):
...
def verify_task5():
    ...
    if os.path.isfile("task5_scatter.png"):
...
def verify_task6():
    ...
    if os.path.isfile("task6_bar.png"):
